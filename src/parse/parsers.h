...
/**
* @brief Struct which encapsulates all the permissions for the three user types.
*/ 
typedef struct {
    /**
...
/**
* @brief Assembles an octal number from a struct with all the three users' permissions.
* 
