...
/**
 * @brief Assembles, from an octal number, a struct with the file permissions for an
 * user type.
 *
...
/**
 * @brief Assembles into a struct all the file permissions for the three user types.
 *
