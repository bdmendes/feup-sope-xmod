...
/**
 * @brief Verifies if the path corresponds to the current or the previous
 * directory.
 *
 * @param path path
 * @return true, if the path corresponds to the current or the previous
 ...
 * @return true, if the argument is composed by permissions flags; false,
 * otherwise
 */
...
/**
 * @brief Verifies if the argument starts with a comma, has two followed commas
 * or ends with a comma.
 *
 * @param str argument
 * @return true, if the argument starts with a comma, has two followed commas or
 * ends with a comma; false, otherwise
 */
